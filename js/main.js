...
function AllChart() {
  ...
  let chart4 = Highcharts.chart("container-4", {
    ...
    title: {
      text: `PM Progress for ${titleSheet4[0]}`,
    },
    xAxis: {
  ...
  let chart5 = Highcharts.chart("container-5", {
    ...
    title: {
      text: `Installed Base VS Transactions ${titleSheet5[0]}`,
      align: "center",
    },
    plotOptions: {
      series: {
  ...
  let chart6 = Highcharts.chart("container-6", {
    ...
    title: {
      text: `Transactions ${titleSheet5[0]}`,
      align: "center",
    },
    xAxis: {
  ...
  let chart7 = Highcharts.chart("container-7", {
    ...
    title: {
      text: `SLA Overview ${titleSheet6[0]}`,
      align: "center",
    },
    xAxis: {
